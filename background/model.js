/**
 * @filedesc Model API: Stores notes, activity logs, and user info.
 *
...
model.updateNoteOrder = function(noteOrder) {
  ...
  model.publisher.trigger(model.EventType.UPDATE_NOTE_ORDER,
			  noteOrder)
}
 ...
 * @param {Object} log The Activity Log object to save.
 */
